...
def main():
    ...
    while True:
        if Game_time >= 3600:
            if Game_win_screen < 120:
                font_you_win = pygame.font.SysFont('arial', 120)
                screen.blit(space_surf, (0, 0))
                You_win = font_you_win.render("You win", 1, (255, 255, 255))
                screen.blit(You_win, [225, 250])
                ...
                exit()
        if lives == 0:
            if Game_lose_screen < 120:
                font_you_lose = pygame.font.SysFont('arial', 120)
                screen.blit(space_surf, (0, 0))
                You_lose = font_you_lose.render("You lose", 1, (255, 255, 255))
                screen.blit(You_lose, [225, 250])
                pygame.display.update()
                clock.tick(FPS)
                Game_lose_screen += 1
            else:
